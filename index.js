...
//  Some stuff worked differently before v10.
  ...
  const wrap = (obj, fn) => {
    return (...args) => {
      try {
        ...
        //  In earlier Node.js versions, assert.throws threw just Error instance.
